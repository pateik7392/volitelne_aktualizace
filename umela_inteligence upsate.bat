...
:verzeanovinky
echo verze umele_inteligence 1.2.4
echo 1. nove budeu aktualizace pravidelne
echo 2. novinka! myni budou volitelne aktualizace ktere si vyberete podle toho 
jakou zrovna chcete
